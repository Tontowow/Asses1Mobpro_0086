...
import com.tontowi0086.mobpro1.navigation.Screen
...
val colorOptions = listOf(Color(0xFFB3E5FC), Color(0xFFC8E6C9), Color(0xFFFFCDD2)) // Biru Muda, Hijau Muda, Merah Muda
...
fun ListItem(peminjaman: Peminjaman, onClick: () -> Unit) {
    Column(
        ...
        Text(text = "${peminjaman.jumlahHari} hari")
    }
}

@Composable
fun GridItem(peminjaman: Peminjaman, modifier: Modifier = Modifier, onClick: () -> Unit) {
    Card(
        modifier = modifier
            .fillMaxWidth()
            .clickable { onClick() },
