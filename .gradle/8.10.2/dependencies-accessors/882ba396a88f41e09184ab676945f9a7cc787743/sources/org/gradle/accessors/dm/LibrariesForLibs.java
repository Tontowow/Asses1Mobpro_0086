...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        private final AndroidLifecyleLibraryAccessors laccForAndroidLifecyleLibraryAccessors = new AndroidLifecyleLibraryAccessors(owner);

        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.lifecyle</b>
         */
        public AndroidLifecyleLibraryAccessors getLifecyle() {
            return laccForAndroidLifecyleLibraryAccessors;
        }

    }

    public static class AndroidLifecyleLibraryAccessors extends SubDependencyFactory {
        private final AndroidLifecyleViewmodelLibraryAccessors laccForAndroidLifecyleViewmodelLibraryAccessors = new AndroidLifecyleViewmodelLibraryAccessors(owner);

        public AndroidLifecyleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.lifecyle.viewmodel</b>
         */
        public AndroidLifecyleViewmodelLibraryAccessors getViewmodel() {
            return laccForAndroidLifecyleViewmodelLibraryAccessors;
        }

    }

    public static class AndroidLifecyleViewmodelLibraryAccessors extends SubDependencyFactory {

        public AndroidLifecyleViewmodelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("android.lifecyle.viewmodel.compose");
        }
    ...
    public static class AndroidxLifecycleViewmodelComposeLibraryAccessors extends SubDependencyFactory {

        public AndroidxLifecycleViewmodelComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v270</b> with <b>androidx.lifecycle:lifecycle-viewmodel-compose</b> coordinates and
         * with version reference <b>lifecycleViewmodelCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV270() {
            return create("androidx.lifecycle.viewmodel.compose.v270");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>datastorePreferences</b> with value <b>1.1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>devtoolsKsp</b> with value <b>2.0.0-1.0.24</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navCompose</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationRuntimeAndroid</b> with value <b>2.9.0-alpha09</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
